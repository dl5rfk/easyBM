...
<div class="container">
 <div class="row">
   ...
   <div class="col-md-5">
	  ...
	  Please do not forget to save the configuration and to restart IRCDDBGATEWAY Software.<br />
	  ...
	  <br /><a href="/admin/service-handler.php?cmd=restart-ircddbgateway" class="btn btn-danger">Restart ircddbgateway</a>
   </div>
   <div class="col-md-1"></div>
