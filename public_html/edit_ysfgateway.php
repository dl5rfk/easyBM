...
$filename='/etc/YSFGateway/YSFGateway.ini';
...
<div class="container">
 <div class="row">
   ...
   <div class="col-md-5">
	  ...
	  Please do not forget to save the configuration and to restart YSFGateway Software.<br />
	  Some informaions about the values:<br/><br/>
	  ...
	  <br /><a href="/admin/service-handler.php?cmd=restart-mmdvm" class="btn btn-danger">Restart YSFGateway</a>
   </div>
   <div class="col-md-1"></div>
</div>
</div>
